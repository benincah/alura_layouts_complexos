...
public class DataUtil {
    ...
    public static String periodoEmTexto(int dias) {
        ...
        String dataForamataIda = formatoBrasileiro.format(dataIda.getTime());
        String dataForamataVolta = formatoBrasileiro.format(dataVolta.getTime());
        return dataForamataIda
                + " - "
                + dataForamataVolta
                + " de "
